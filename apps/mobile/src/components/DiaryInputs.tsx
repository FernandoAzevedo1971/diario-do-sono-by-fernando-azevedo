...
const timeStyles = StyleSheet.create({
  ...
  digit: { color: colors.text, fontSize: 40, fontWeight: '900', minWidth: 56, textAlign: 'center' },
  colon: { color: colors.text, fontSize: 40, fontWeight: '900', marginBottom: 18 },
  arrow: { paddingHorizontal: spacing.sm, paddingVertical: 3 },
  arrowText: { color: colors.cyan, fontSize: 17, fontWeight: '700' },
  unitLabel: { color: colors.textMuted, fontSize: 11, fontWeight: '600' },
  track: {
    height: 34,
...
const stepStyles = StyleSheet.create({
  ...
  pressed: { opacity: 0.7 },
  btnText: { color: colors.primaryLight, fontSize: 24, fontWeight: '700', lineHeight: 28 },
  valueArea: { alignItems: 'center', minWidth: 90 },
  value: { color: colors.text, fontSize: 40, fontWeight: '900', lineHeight: 46 },
  suffix: { color: colors.textMuted, fontSize: 14, fontWeight: '600', marginTop: -3 },
});
...
const durStyles = StyleSheet.create({
  ...
  unit: { alignItems: 'center', gap: 4 },
  digit: { color: colors.text, fontSize: 40, fontWeight: '900', minWidth: 56, textAlign: 'center' },
  colon: { color: colors.textMuted, fontSize: 24, fontWeight: '700', marginBottom: 20, marginHorizontal: 4 },
  arrow: { paddingHorizontal: spacing.sm, paddingVertical: 3 },
  arrowText: { color: colors.cyan, fontSize: 17, fontWeight: '700' },
